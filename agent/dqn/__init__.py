...
class DQNAgent(Agent):
    """The DQN agent."""
    def __init__(self, input_shape, h1, actions, warm_up=0, policy=EpsilonGreedyPolicy(0.1), memory_size=3000,
                 batch_size=64, learning_rate=0.001, training=True, seed=0):
        # Super Call
